...
public class GameManagerNN : Singleton<GameManagerNN>
{
    protected GameManagerNN() { }
    ...
    [SerializeField] private AIVehicleNN racecar = null;
    ...
    public void AssignRacecar(AIVehicleNN car)
    {
        if (carAssigned)
        {
